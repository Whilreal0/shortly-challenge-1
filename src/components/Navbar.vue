  ...
  <nav class="">
    <div
      ...
      relative
        ...
        px-5
        py-[50px]
        lg:pl-[125px] lg:justify-start lg:gap-[50px]
        items-center
        2xl:px-[125px]
      "
    >
      ...
      <!-- mobile nav -->
      <span class="cursor-pointer md:hidden" @click="openNav">
        <box-icon size="md" color="hsl(0, 0%, 75%)" name="menu"></box-icon>
      </span>
      <div
        v-if="isOpen"
        class="bg-[#3B3054]  flex flex-col gap-[30px] absolute left-3 right-3  top-[110px] py-10 px-6 rounded-[8px] md:hidden"
        id="mobilenav"
      >
        <ul class="min-w-[300px] text-center flex flex-col gap-[30px]">
          <li class="text-lg font-bold text-white cursor-pointer hover:text-black">Features</li>
          <li class="text-lg font-bold text-white cursor-pointer hover:text-black">Pricing</li>
          <li class="text-lg font-bold text-white cursor-pointer hover:text-black">Resources</li>
        </ul>
        <hr>
        <div class="flex flex-col gap-[30px]">
          <button
            class="text-white font-bold text-lg hover:text-black"
          >
            Login
          </button>
          <button
      ...
      <div class="hidden md:flex">
        <ul class="flex flex-row gap-10 text-[#9E9AA7] font-bold">
          <li class="cursor-pointer hover:text-black">Features</li>
          <li class="cursor-pointer hover:text-black">Pricing</li>
          <li class="cursor-pointer hover:text-black">Resources</li>
        </ul>
        <div class="flex flex-row gap-12 pl-16 xl:ml-[200px] 2xl:ml-[29rem]">
          <button
            class="text-[#9E9AA7] font-bold text-[15.2px] hover:text-black"
          >
            Login
          </button>
          <button
